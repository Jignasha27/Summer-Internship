...
namespace Mission.Entities
{
    ...
    {
      modelBuilder.Entity<Models.Mission>().ToTable("missions");
      modelBuilder.Entity<Country>().ToTable("countries");
      modelBuilder.Entity<City>().ToTable("cities");

      modelBuilder.Entity<City>().Property(c => c.Id).HasColumnName("id");
      modelBuilder.Entity<City>().Property(c => c.CountryId).HasColumnName("country_id");
      modelBuilder.Entity<City>().Property(c => c.CityName).HasColumnName("city_name");
