...
namespace Mission.Repositories.Repository
{
    public class UserRepository(MissionDbContext dbContext) : IUserRepository
    {
        ...
        {
            var user = await _context.Users.Where(u => u.Email.ToLower() == model.EmailAddress.ToLower()).FirstOrDefaultAsync();
        ...
        {
            var userInDb = _context.Users.Where(u => u.Email.ToLower() == model.EmailAddress.ToLower()).FirstOrDefault();
        ...
        {
            var userInDb = _context.Users.Where(u => model.Id != u.Id && u.Email.ToLower() == model.EmailAddress.ToLower()).FirstOrDefault();
